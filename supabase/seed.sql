...
('a1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000004')
ON CONFLICT DO NOTHING;

-- PRODUCT IMAGES
INSERT INTO product_images (id, product_id, url, alt_text, display_order, is_primary) VALUES
('b1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1200&q=80', 'Apex ANC Headphones Matte Black', 0, true),
('b1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1484704849700-f032a568e944?auto=format&fit=crop&w=1200&q=80', 'Apex ANC Headphones Audio Details', 1, false),
('b1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=1200&q=80', 'Chronos Sapphire Smartwatch Front', 0, true),
('b1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=1200&q=80', 'Nomad Full-Grain Leather Weekender Tan', 0, true),
('b1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=1200&q=80', 'Urban Heavyweight Hoodie Charcoal', 0, true)
ON CONFLICT DO NOTHING;

-- PRODUCT VARIANTS
INSERT INTO product_variants (id, product_id, sku, title, options, price, stock_quantity, image_url) VALUES
('d1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'AUD-APX-BLK', 'Matte Black', '{"Color": "Matte Black"}', 1250.00, 25, 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1200&q=80'),
('d1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'AUD-APX-SLV', 'Silver Titanium', '{"Color": "Silver Titanium"}', 1250.00, 14, 'https://images.unsplash.com/photo-1484704849700-f032a568e944?auto=format&fit=crop&w=1200&q=80'),
('d1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'WRB-CHR-BLK-O', 'Midnight Onyx', '{"Color": "Midnight Onyx"}', 2400.00, 10, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=1200&q=80'),
('d1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000003', 'LTH-NMD-COG', 'Cognac Brown', '{"Color": "Cognac Brown"}', 1650.00, 8, 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=1200&q=80'),
('d1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000004', 'APP-HOO-BLK-M', 'Charcoal Black / Medium', '{"Color": "Charcoal Black", "Size": "Medium"}', 680.00, 30, 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=1200&q=80'),
('d1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000004', 'APP-HOO-BLK-L', 'Charcoal Black / Large', '{"Color": "Charcoal Black", "Size": "Large"}', 680.00, 20, 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=1200&q=80')
ON CONFLICT (sku) DO NOTHING;

-- 4. DELIVERY ZONES & RATES
INSERT INTO delivery_zones (id, name, description, estimated_delivery_days) VALUES
('e1000000-0000-0000-0000-000000000001', 'Greater Accra Central', 'Express door delivery within Accra metro', '24 - 48 Hours'),
('e1000000-0000-0000-0000-000000000002', 'Tema & Environs', 'Standard delivery to Tema, Kpone, and Ashaiman', '2 - 3 Days'),
('e1000000-0000-0000-0000-000000000003', 'Kumasi & Ashanti Region', 'Express regional freight to Kumasi urban centers', '3 - 4 Days'),
('e1000000-0000-0000-0000-000000000004', 'Other Regions (Nationwide)', 'Courier delivery to all other regional capitals in Ghana', '4 - 6 Days'),
('e1000000-0000-0000-0000-000000000005', 'Store Pickup (Osu Flagship)', 'Pick up directly at our flagship store in Osu, Accra', 'Same Day')
ON CONFLICT (name) DO NOTHING;

INSERT INTO delivery_rates (zone_id, rate, free_shipping_threshold, min_order_amount) VALUES
('e1000000-0000-0000-0000-000000000001', 35.00, 2000.00, 0.00),
('e1000000-0000-0000-0000-000000000002', 45.00, 2500.00, 0.00),
('e1000000-0000-0000-0000-000000000003', 60.00, 3000.00, 0.00),
('e1000000-0000-0000-0000-000000000004', 85.00, 3500.00, 0.00),
('e1000000-0000-0000-0000-000000000005', 0.00, 0.00, 0.00)
ON CONFLICT DO NOTHING;
